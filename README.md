...
- 请求参数：`不必要`
  ...
  - 不加请求参数为默认 `1`
    ...
    - `bili=2` ：竖图
    - `bili=3` ：似正方形
- 示例1：[https://api.ayaka.icu/img/url.io](https://api.ayaka.icu/img/url.io) 获取数据一张横图图片
- 示例2：[https://api.ayaka.icu/img/url.io?bili=2](https://api.ayaka.icu/img/url.io?bili=2) 获取数据一张横图图片
- 注意：性能`GET: /img/url`差
